      ...
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          <a href="/">
            ...
            <p className="mt-6 text-base leadding-7 font-montserrat text-white-400 sm:max-w-sm">
              Get shoes ready for the new term at your
              nearest Nike store. ind Your perfect Size In
              Store. Get Rewards
            </p>
          </a>
                ...
                <ul>
                  {section.links.map((link)=>(
                    <li key={link} className="mt-3 text-white-400 font-montserrat text-base leading-normal hover:text-slate-gray">
                      <a  className="text-white-400 hover:text-white">{link.name}</a>
                    </li>
                  ))}
                </ul>
              </div>
